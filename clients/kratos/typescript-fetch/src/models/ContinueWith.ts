...
export function ContinueWithFromJSONTyped(json: any, ignoreDiscriminator: boolean): ContinueWith {
    ...
    switch (json['action']) {
        case 'set_ory_session_token':
            return {...ContinueWithSetOrySessionTokenFromJSONTyped(json, true), action: 'set_ory_session_token'};
        case 'show_recovery_ui':
            return {...ContinueWithRecoveryUiFromJSONTyped(json, true), action: 'show_recovery_ui'};
        case 'show_settings_ui':
            return {...ContinueWithSettingsUiFromJSONTyped(json, true), action: 'show_settings_ui'};
        case 'show_verification_ui':
            return {...ContinueWithVerificationUiFromJSONTyped(json, true), action: 'show_verification_ui'};
        default:
