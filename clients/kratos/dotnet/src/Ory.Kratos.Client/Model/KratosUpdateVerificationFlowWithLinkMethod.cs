...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosUpdateVerificationFlowWithLinkMethod : IValidatableObject
    {
        ...
        public KratosUpdateVerificationFlowWithLinkMethod(string csrfToken = default(string), string email = default(string), MethodEnum method = default(MethodEnum), Object transientPayload = default(Object))
        {
