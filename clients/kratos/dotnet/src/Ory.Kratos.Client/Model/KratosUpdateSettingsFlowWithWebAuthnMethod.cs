...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosUpdateSettingsFlowWithWebAuthnMethod : IValidatableObject
    {
        ...
        protected KratosUpdateSettingsFlowWithWebAuthnMethod()
        {
        ...
        public KratosUpdateSettingsFlowWithWebAuthnMethod(string csrfToken = default(string), string method = default(string), Object transientPayload = default(Object), string webauthnRegister = default(string), string webauthnRegisterDisplayname = default(string), string webauthnRemove = default(string))
        {
            // to ensure "method" is required (not null)
            if (method == null)
            {
                throw new ArgumentNullException("method is a required property for KratosUpdateSettingsFlowWithWebAuthnMethod and cannot be null");
            }
            this.Method = method;
