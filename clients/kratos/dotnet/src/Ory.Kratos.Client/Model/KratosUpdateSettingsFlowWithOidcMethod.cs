...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosUpdateSettingsFlowWithOidcMethod : IValidatableObject
    {
        ...
        public KratosUpdateSettingsFlowWithOidcMethod(string flow = default(string), string link = default(string), string method = default(string), Object traits = default(Object), Object transientPayload = default(Object), string unlink = default(string), Object upstreamParameters = default(Object))
        {
