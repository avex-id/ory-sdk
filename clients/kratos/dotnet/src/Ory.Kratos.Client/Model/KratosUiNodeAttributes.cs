...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosUiNodeAttributes : AbstractOpenAPISchema, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KratosUiNodeAttributes" /> class
        /// with the <see cref="KratosUiNodeScriptAttributes" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of KratosUiNodeScriptAttributes.</param>
        public KratosUiNodeAttributes(KratosUiNodeScriptAttributes actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                ...
                else if (value.GetType() == typeof(KratosUiNodeScriptAttributes))
                {
                    this._actualInstance = value;
                }
                ...
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: KratosUiNodeAnchorAttributes, KratosUiNodeImageAttributes, KratosUiNodeInputAttributes, KratosUiNodeScriptAttributes, KratosUiNodeTextAttributes");
                }
            }
        }
        ...
        /// <summary>
        /// Get the actual instance of `KratosUiNodeScriptAttributes`. If the actual instance is not `KratosUiNodeScriptAttributes`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of KratosUiNodeScriptAttributes</returns>
        public KratosUiNodeScriptAttributes GetKratosUiNodeScriptAttributes()
        {
            return (KratosUiNodeScriptAttributes)this.ActualInstance;
        }
        ...
        public static KratosUiNodeAttributes FromJson(string jsonString)
        {
            ...
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
                if (typeof(KratosUiNodeScriptAttributes).GetProperty("AdditionalProperties") == null)
                {
                    newKratosUiNodeAttributes = new KratosUiNodeAttributes(JsonConvert.DeserializeObject<KratosUiNodeScriptAttributes>(jsonString, KratosUiNodeAttributes.SerializerSettings));
                }
                else
                {
                    newKratosUiNodeAttributes = new KratosUiNodeAttributes(JsonConvert.DeserializeObject<KratosUiNodeScriptAttributes>(jsonString, KratosUiNodeAttributes.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("KratosUiNodeScriptAttributes");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into KratosUiNodeScriptAttributes: {1}", jsonString, exception.ToString()));
            }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            switch(reader.TokenType) 
            {
                ...
                case JsonToken.StartArray:
                    return KratosUiNodeAttributes.FromJson(JArray.Load(reader).ToString(Formatting.None));
                default:
                    return null;
            }
        }
