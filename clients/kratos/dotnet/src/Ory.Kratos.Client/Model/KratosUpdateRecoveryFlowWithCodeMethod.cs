...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosUpdateRecoveryFlowWithCodeMethod : IValidatableObject
    {
        /// <summary>
        ...
        protected KratosUpdateRecoveryFlowWithCodeMethod()
        {
        ...
        public KratosUpdateRecoveryFlowWithCodeMethod(string code = default(string), string csrfToken = default(string), string email = default(string), MethodEnum method = default(MethodEnum), Object transientPayload = default(Object))
        {
            this.Method = method;
            this.Code = code;
