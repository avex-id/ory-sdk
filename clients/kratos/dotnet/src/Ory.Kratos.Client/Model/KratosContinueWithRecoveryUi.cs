...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosContinueWithRecoveryUi : IValidatableObject
    {
        ...
        protected KratosContinueWithRecoveryUi()
        {
        ...
        public KratosContinueWithRecoveryUi(ActionEnum action = default(ActionEnum), KratosContinueWithRecoveryUiFlow flow = default(KratosContinueWithRecoveryUiFlow))
        {
            this.Action = action;
            // to ensure "flow" is required (not null)
            if (flow == null)
            {
                throw new ArgumentNullException("flow is a required property for KratosContinueWithRecoveryUi and cannot be null");
            }
            this.Flow = flow;
            this.AdditionalProperties = new Dictionary<string, object>();
        }
