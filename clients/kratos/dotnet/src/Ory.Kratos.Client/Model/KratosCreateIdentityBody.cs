...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosCreateIdentityBody : IValidatableObject
    {
        ...
        protected KratosCreateIdentityBody()
        {
        ...
        public KratosCreateIdentityBody(KratosIdentityWithCredentials credentials = default(KratosIdentityWithCredentials), Object metadataAdmin = default(Object), Object metadataPublic = default(Object), List<KratosRecoveryIdentityAddress> recoveryAddresses = default(List<KratosRecoveryIdentityAddress>), string schemaId = default(string), StateEnum? state = default(StateEnum?), Object traits = default(Object), List<KratosVerifiableIdentityAddress> verifiableAddresses = default(List<KratosVerifiableIdentityAddress>))
        {
            // to ensure "schemaId" is required (not null)
            if (schemaId == null)
            {
                throw new ArgumentNullException("schemaId is a required property for KratosCreateIdentityBody and cannot be null");
            }
            this.SchemaId = schemaId;
            // to ensure "traits" is required (not null)
            if (traits == null)
            {
                throw new ArgumentNullException("traits is a required property for KratosCreateIdentityBody and cannot be null");
            }
            this.Traits = traits;
