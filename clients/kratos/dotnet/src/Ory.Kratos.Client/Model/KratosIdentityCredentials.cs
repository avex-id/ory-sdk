...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosIdentityCredentials : IValidatableObject
    {
        ...
        public KratosIdentityCredentials(Object config = default(Object), DateTime createdAt = default(DateTime), List<string> identifiers = default(List<string>), TypeEnum? type = default(TypeEnum?), DateTime updatedAt = default(DateTime), long varVersion = default(long))
        {
            this.Config = config;
