...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosUpdateLoginFlowWithOidcMethod : IValidatableObject
    {
        ...
        protected KratosUpdateLoginFlowWithOidcMethod()
        {
        ...
        public KratosUpdateLoginFlowWithOidcMethod(string csrfToken = default(string), string idToken = default(string), string idTokenNonce = default(string), string method = default(string), string provider = default(string), Object traits = default(Object), Object transientPayload = default(Object), Object upstreamParameters = default(Object))
        {
            // to ensure "method" is required (not null)
            if (method == null)
            {
                throw new ArgumentNullException("method is a required property for KratosUpdateLoginFlowWithOidcMethod and cannot be null");
            }
            this.Method = method;
            // to ensure "provider" is required (not null)
            if (provider == null)
            {
                throw new ArgumentNullException("provider is a required property for KratosUpdateLoginFlowWithOidcMethod and cannot be null");
            }
