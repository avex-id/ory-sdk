...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosUpdateSettingsFlowWithProfileMethod : IValidatableObject
    {
        ...
        public KratosUpdateSettingsFlowWithProfileMethod(string csrfToken = default(string), string method = default(string), Object traits = default(Object), Object transientPayload = default(Object))
        {
